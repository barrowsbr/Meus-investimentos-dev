...
function EarthSphere({ radius }: { radius: number }) {
  ...
  const mat = useMemo(() => new THREE.ShaderMaterial({
    vertexShader: EARTH_SHADER_VERT,
    fragmentShader: EARTH_SHADER_FRAG,
    uniforms: {
