...
interface ChartPoint { date: string; nav: number; flow: number; ret: number; twr: number; cdi_twr?: number | null; ibov_twr?: number | null; fx_twr?: number | null; ativo_twr?: number | null }
    ...
    <>
      ...
      {activeTab === "overview" && (
        <div className="space-y-4">
          ...
          {/* FX Decomposition time-series chart */}
          {chartData.length > 0 && chartData.some(p => p.fx != null) && (
            <div className="glass-card p-5">
