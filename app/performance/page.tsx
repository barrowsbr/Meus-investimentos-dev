...
export default function PerformancePage() {
  ...
  const chartData = useMemo(() => {
    return activeChart.map(p => ({
      ...
      europa: p.europa_twr != null ? +(p.europa_twr * 100).toFixed(2) : null,
      dax: p.dax_twr != null ? +(p.dax_twr * 100).toFixed(2) : null,
      japao: p.japao_twr != null ? +(p.japao_twr * 100).toFixed(2) : null,
      asia: p.asia_twr != null ? +(p.asia_twr * 100).toFixed(2) : null,
      emergentes: p.emergentes_twr != null ? +(p.emergentes_twr * 100).toFixed(2) : null,
