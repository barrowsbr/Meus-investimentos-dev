...
import {
  ...
  Globe as GlobeIcon, Activity, Play, History, ExternalLink, Zap,
} from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="max-w-4xl">
        ...
        <SectionCard title="Automações (Cron & GitHub Actions)" icon={<Zap size={16} />}>
          <AutomacoesSection />
        </SectionCard>

        <SectionCard title="Histórico patrimonial (GitHub Action)" icon={<History size={16} />}>
          <HistoricoSection />
        </SectionCard>

        <SectionCard title="APIs & Integrações (Diagnóstico)" icon={<Activity size={16} />}>
          <ApiHealthSection />
        </SectionCard>
