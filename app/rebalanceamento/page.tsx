...
export default function RebalanceamentoPage() {
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-6">
      <PageHeader title="Rebalanceamento" description="Metas por classe, desvio vs alvo e ações sugeridas — alocação do motor canônico" />
      ...
      {loading ? (
        ...
        <div className="glass-card p-8 text-center text-sm text-zinc-500">Sem alocação para exibir.</div>
      ) : (
