    ...
    with tab1:
        ...
        if not df_grafico.empty:
            ...
            with col_dir:
                ...
                fig_moeda.update_layout(margin=dict(t=10, l=10, r=10, b=10), height=500, showlegend=True)
                ...
                fig_local.update_layout(margin=dict(t=10, l=10, r=10, b=10), height=500, showlegend=True)
