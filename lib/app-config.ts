...
export type EscopoConfig = "historico" | "alertas" | "alertas_estado" | "automacoes" | "bens" | "cartao";
...
const LEGADO: Record<EscopoConfig, { tab: string; valorCol: string }> = {
  ...
  // "bens" e "cartao" nasceram já na app_config — não existe aba legada (o
  // fallback lê uma aba inexistente e devolve vazio, que é o comportamento certo).
  bens: { tab: "bens_config", valorCol: "valor" },
  cartao: { tab: "cartao_config", valorCol: "valor" },
};
