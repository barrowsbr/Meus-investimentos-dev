// ─────────────────────────────────────────────────────────────────────────────
// ISO numérico → ISO alpha-2 — módulo FOLHA (zero imports) de propósito:
// countries.ts e geo.ts precisam os dois deste mapa, e quando ele morava em
// countries.ts existia um ciclo countries ⇄ geo que estourava TDZ ("Cannot
// access 'u' before initialization") dependendo da ordem de import da página
// (quebrou a /moedas). Não adicionar imports aqui.
// ─────────────────────────────────────────────────────────────────────────────
