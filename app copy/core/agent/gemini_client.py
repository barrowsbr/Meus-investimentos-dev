...
# Modelo usado para validar a chave de API no init.
_VALIDATION_MODEL_NEW = "gemini-2.5-flash"
_VALIDATION_MODEL_OLD = "gemini-2.5-flash"
...
class GeminiAgent:
    ...
    def update_web_search(self, enabled: bool) -> None:
        """Ativa/desativa web search sem reinjetar contexto. Preserva o histórico."""
